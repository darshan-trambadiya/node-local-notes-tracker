...
exports.getHomePage = async (req, res, next) => {
  try {
    res.render("home_page", {
      pageTitle: "Home Page | Local Notes Tracker",
      path: "/",
    });
  } catch (error) {
    console.error(
...
exports.getNotesPage = async (req, res, next) => {
  try {
    ...
    res.render("notes/notes_page", {
      notes: notes,
      pageTitle: "All Notes | Local Notes Tracker",
      path: "/notes",
    });
  } catch (error) {
    console.error(
...
exports.getNoteDetailsPage = async (req, res, next) => {
  try {
    ...
    res.render("notes/note_details", {
      note: note,
      pageTitle: `${note.title} Note Details | Local Notes Tracker`,
      path: "/notes/:noteId",
    });
  } catch (error) {
    console.error(
...
exports.getAddNotePage = (req, res, next) => {
  res.render("notes/add_edit_note", {
    pageTitle: "Add Note | Local Notes Tracker",
    path: "/add-note",
    editing: false,
  });
};
...
exports.getEditNotePage = async (req, res, next) => {
  try {
    ...
    res.render("notes/add_edit_note", {
      pageTitle: "Edit Note | Local Notes Tracker",
